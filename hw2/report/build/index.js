(() => {
  // hw1/report/icon/arrow_back_ios-white-18dp.svg
  var arrow_back_ios_white_18dp_default = "data:image/svg+xml;base64,";

  // hw1/report/icon/arrow_forward_ios-white-18dp.svg
  var arrow_forward_ios_white_18dp_default = "data:image/svg+xml;base64,";
...
- For vite: pass it via @vitejs/plugin-vue options. See https://github.com/vitejs/vite/tree/main/packages/plugin-vue#example-for-passing-options-to-vuecompiler-dom`;
  ...
  var css = (() => {
    ...
    const p2 = {
      ...
      y(mm) {
        return p2.t(mm) + p2.b(mm);
      },
      x(mm) {
        return p2.l(mm) + p2.r(mm);
      },
      all(mm) {
        return p2.x(mm) + p2.y(mm);
      },
      auto: () => `padding:auto;`
    };
    const tx = {
  ...
  // hw1/report/dev/template.tsx
  var DivVC = defineComponent((_props, { slots }) => {
    return () => {
  ...
  var DivHC = defineComponent((_, { slots }) => {
    return () => {
      return /* @__PURE__ */ h("div", {
        class: "text-xl",
        style: [
          css.p.all(slots.padding?.() ?? 10),
          css.tx.center(),
          css.w.percent(100)
        ]
      }, slots.default());
  ...
  var Title = defineComponent((_props, { slots }) => {
    return () => /* @__PURE__ */ h(Fragment, null, /* @__PURE__ */ h(DivVC, null, () => /* @__PURE__ */ h(DivHC, null, {
      default: () => /* @__PURE__ */ h(Fragment, null, /* @__PURE__ */ h("span", {
        class: "text-3xl"
      }, slots.title()), /* @__PURE__ */ h("hr", null), /* @__PURE__ */ h("p", {
        class: "text-lg",
        style: [css.tx.left(), css.w.percent(48), css.m.auto()]
      }, slots.authors().reduce((prev, author) => {
        return [...prev, author, ", "];
      }, []).slice(0, -1)))
    })));
  });
  var Outline = defineComponent((_, { slots }) => {
  ...
  var Tmpl1 = defineComponent((_, { slots }) => {
    return () => /* @__PURE__ */ h(Fragment, null, /* @__PURE__ */ h(DivVC, null, () => /* @__PURE__ */ h(DivHC, null, {
      default: () => /* @__PURE__ */ h(Fragment, null, /* @__PURE__ */ h("span", {
        class: "text-3xl"
  ...
  var Tmpl2 = defineComponent((_, { slots }) => {
    return () => /* @__PURE__ */ h(Fragment, null, /* @__PURE__ */ h(DivVC, null, () => /* @__PURE__ */ h(DivHC, null, {
      default: () => /* @__PURE__ */ h(Fragment, null, /* @__PURE__ */ h("p", {
        style: [css.tx.left(), css.pos.abs()]
      }, /* @__PURE__ */ h("span", {
        class: "text-base"
  ...
  var Tmpl3 = defineComponent((_, { slots }) => {
    return () => /* @__PURE__ */ h(Fragment, null, /* @__PURE__ */ h(DivVC, null, () => /* @__PURE__ */ h(DivHC, null, {
      default: () => /* @__PURE__ */ h(Fragment, null, /* @__PURE__ */ h("p", {
        style: [css.tx.left(), css.pos.abs(), css.w.mm(277)]
      }, /* @__PURE__ */ h("span", {
        class: "text-base"
      }, slots.title1())), /* @__PURE__ */ h("p", {
        style: [css.tx.right(), css.pos.abs(), css.w.mm(277)]
      }, /* @__PURE__ */ h("span", {
        class: "text-base"
  ...
  // hw1/report/dev/index.tsx
  var Page = defineComponent((props, { slots }) => {
    return () => {
      return /* @__PURE__ */ h("div", {
        class: "page"
      }, slots.default());
  ...
  var App = defineComponent(() => {
    ...
    const pages = [
      /* @__PURE__ */ h(Tmpl1, null, {
        title: () => /* @__PURE__ */ h(Fragment, null, "\u7D71\u8A08\u65B9\u5F0F"),
        content: () => /* @__PURE__ */ h(Fragment, null, "\u76EE\u524D\u662F\u900F\u904E\u51FD\u5F0F\u5EAB compromise \u7684\u5E6B\u52A9\u5206\u5272\u6587\u672C", /* @__PURE__ */ h("ul", null, /* @__PURE__ */ h("li", null, "Word\uFF1A\u5229\u7528 compromise \u5C07\u53E5\u5B50\u4E2D\u7684\u6A19\u9EDE\u7B26\u865F\u79FB\u9664\u4E26\u62C6\u5206 Apostrophe \u7684\u7E2E\u5BEB\u5F8C\u624D\u8A08\u7B97\u5B57\u6578\u3002"), /* @__PURE__ */ h("li", null, "Sentence\uFF1A\u900F\u904E compromise \u8F14\u52A9\u62C6\u5206\u53E5\u5B50\u5F8C\u624D\u9032\u884C\u8A08\u7B97\u3002")))
      }),
      /* @__PURE__ */ h(Tmpl1, null, {
        title: () => /* @__PURE__ */ h(Fragment, null, "\u7CFB\u7D71\u67B6\u69CB"),
        content: () => /* @__PURE__ */ h("img", {
    ...
    return () => /* @__PURE__ */ h("div", {
      ...
      return /* @__PURE__ */ h(Page, {
        class: idx != state.page ? "none" : ""
      }, () => /* @__PURE__ */ h(Fragment, null, page, /* @__PURE__ */ h("div", {
        class: ["page-num", "text-lg"]
      }, idx + 1)));
    }), /* @__PURE__ */ h("img", {
      onClick: back,
      src: arrow_back_ios_white_18dp_default,
      class: "page-back-button"
    }), /* @__PURE__ */ h("img", {
      onClick: forward,
      src: arrow_forward_ios_white_18dp_default,
